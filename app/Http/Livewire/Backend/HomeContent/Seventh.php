...
class Seventh extends Component
{
    ...
    {
       $this->records = HomeContentSeventh::get(); 
        return view('livewire.backend.home-content.seventh')->layout('layouts.backend');
    }
    ...
    protected $rules = [ 
     ...
     public function saveRecord(){
      ...
      $homeContentSeventh = new HomeContentSeventh();
     ...
     public function delete($id){
      ...
      if(!is_null($homeContentSeventh)){
        $homeContentSeventh->status = 'Inactive';
        $homeContentSeventh->save();
      }
     }
}
