            ...
            <div class="col">
                <div class="feature-box text-center">
                    ...
                    <div class="feature-box-content last-paragraph-no-margin">
                        ...
                        <p class="d-inline-block w-70 lg-w-90 md-w-60 sm-w-80 xs-w-100">Phone: +91 9805092582</p>
                    </div>
                </div>
            </div>
            <!-- end feature box item -->
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-lg-6 col-md-7 col-sm-6 text-center text-sm-start sm-margin-25px-tb xs-margin-30px-bottom">
                ...
                <a href="https://www.sirs.org.in/detail/page/16/about-sirs-1" class="btn btn-extra-large btn-link text-orange">Know More</a>
            </div>
            <div class="col-12 col-lg-6 col-md-5 col-sm-6 social-icon-style-03 text-center text-sm-end sm-margin-25px-tb xs-no-margin-top">
                ...
                <ul class="small-icon">
                    <li><a class="facebook text-extra-dark-gray text-center" href="https://www.facebook.com/shivainternationalresidentialschool" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                    <li><a class="twitter text-extra-dark-gray text-center" href="javascript:void()" target="_blank"><i class="fab fa-twitter"></i></a></li>
                    <li><a class="instagram text-extra-dark-gray text-center" href="https://www.instagram.com/sirs_bilaspur" target="_blank"><i class="fab fa-instagram"></i></a></li>
                    <li><a class="youtube text-extra-dark-gray text-center" href="http://www.youtube.com/@SIRS." target="_blank"><i class="fab fa-youtube"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/sirsorg/public_html/resources/views/livewire/frontend/contact-us.blade.php ENDPATH**/ ?>