...
} elseif ($_instance->childHasBeenRendered('8CqLRZT')) {
    $componentId = $_instance->getRenderedChildComponentId('8CqLRZT');
    $componentTag = $_instance->getRenderedChildComponentTagName('8CqLRZT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8CqLRZT');
} else {
    $response = \Livewire\Livewire::mount('modals.edit-resultx');
    $html = $response->html();
    $_instance->logRenderedChild('8CqLRZT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

    </body>
</html><?php /**PATH C:\xampp\htdocs\scindia\resources\views/layouts/backend.blade.php ENDPATH**/ ?>