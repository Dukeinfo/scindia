		...
		<ul class="metismenu list-unstyled" id="side-menu">
		  ...
		  <li>
			 ...
			 <li>
			  ...
			  <ul class="sub-menu" aria-expanded="false">
					 <li><a href="<?php echo e(route('view_membership')); ?>">Membership</a></li>	
				</ul>
			</li>
...
<li class="menu-title">Gallery</li>
	...
	<!-- Sidebar -->
</div><?php /**PATH C:\xampp\htdocs\laravel-livewire\resources\views/livewire/backend/common/sidenav.blade.php ENDPATH**/ ?>