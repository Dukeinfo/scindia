<div>
      <!-- Main Content -->
<section class="parallax bg-extra-dark-gray" data-parallax-background-ratio="0.5" style="background-image:url(<?php echo e(asset('assets/images/header_bg.jpg')); ?>
                ...
                <div class="row">
                    <div class="col-12 blog-details-text last-paragraph-no-margin margin-6-rem-bottom">
                        <ul class="list-unstyled margin-2-rem-bottom">
                            <li class="d-inline-block align-middle margin-25px-right"><i class="feather icon-feather-calendar text-orange margin-10px-right"></i><a href="javascript:void()"><?php echo e(\Carbon\Carbon::parse($record->created_at)->isoFormat('MMMM Do YYYY')); ?></a></li>
                            <li class="d-inline-block align-middle margin-25px-right"><i class="feather icon-feather-folder text-orange margin-10px-right"></i><a href="javascript:void()"><?php echo e(getBlogCategory($record->category_id) ?? ''); ?></a></li>
                        ...
                        <h5 class="alt-font font-weight-500 text-extra-dark-gray margin-4-half-rem-bottom"><?php echo e($record->title); ?></h5>
                        <img src="<?php echo e(isset($record->image) ? getBlogImage($record->image) : asset('no_image.jpg')); ?>" alt="" class="w-100 border-radius-6px margin-4-half-rem-bottom">
                ...
                <div class="margin-5-rem-bottom xs-margin-35px-bottom wow animate__fadeIn">
                    ...
                    <ul class="list-style-07 list-unstyled">
                      <?php if(isset($categories) && count($categories) >0 ): ?>
                        ...
                        <li><a href="javascript:void()"><?php echo e($category->name); ?></a>
<?php
      $total =App\Models\Blogs::where(['category_id'=> $category->id , 'status' => 'Active' ])->count();
 ?>
                    <span class="item-qty"><?php echo e($total); ?></span></li>
                    ...
                    <ul class="latest-post-sidebar position-relative">
                        ...
                        <li class="d-flex wow animate__fadeIn" data-wow-delay="0.2s">
                            <figure class="flex-shrink-0">
                                <a href="#"><img class="border-radius-3px" src="<?php echo e(getBlogImage($blog->image ) ?? ''); ?>" alt=""></a>
                            </figure>
                            <div class="media-body flex-grow-1">
                                <a href="#" class="font-weight-500 text-extra-dark-gray d-inline-block margin-five-bottom md-margin-two-bottom"><?php echo e($blog->title); ?></a>
                                <span class="text-medium d-block line-height-22px">

<?php echo $blog->description ?str_limit($blog->description, $limit=80 ) : ''; ?>
...
<?php /**PATH /home/sirsorg/public_html/resources/views/livewire/frontend/blog-detail.blade.php ENDPATH**/ ?>