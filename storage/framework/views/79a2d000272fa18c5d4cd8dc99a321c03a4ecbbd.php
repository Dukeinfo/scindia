            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-3 justify-content-center">
                    ...
                    <?php if(isset($contactInfo)): ?>        
                        <?php if(isset($contactInfo->disclaimer)): ?>

                        <p class="mt-4"><?php echo e($contactInfo->disclaimer ?? 'We believe that educating a girl is equal to educating a family. Our institution
                            is
                    ...
                    <?php endif; ?> 
                       ...
                       <?php if(isset($contactInfo)): ?> 
                        <a href="<?php echo e($contactInfo->link ?? 'javascript:void()'); ?>" class="btn btn-neon-orange text-white btn-small" target="_blank">Read More</a>
                        <?php else: ?>
...
?>                  
                    ...
                    <div class="col col-xl-2 col-lg md-margin-50px-bottom xs-margin-25px-bottom">
                        ...
                        <ul>
                            ...
                            <?php if(isset($quickLinks) && count($quickLinks) >0 ): ?>
                               ...
                               ?>
                               <?php if($links->pname): ?>
                               <li><a href="<?php echo e(url($quicklink)); ?>" target="_blank"><?php echo e($links->pagetitle); ?></a></li>
                               <?php elseif($links->mname): ?>
                               <li><a href="<?php echo e($links->mname ?? 'javascript:void()'); ?>" target="_blank"><?php echo e($links->pagetitle); ?></a></li>
                               <?php else: ?>
                    ...
                    <div class="col-12 col-lg-3 col-sm-6 xs-margin-25px-bottom">
                        ...
                        <?php if(isset($contactInfo)): ?>
                           ...
                           <?php echo e($contactInfo->address ?? 'Scindia Kanya Vidyalaya <br>
                            Moti Mahal Road <br>
                            Gwalior - 474007 <br>
                            (M.P.) INDIA'); ?>
                       ...
                       <?php endif; ?> 
                        ...
                        <div><i
                                class="feather icon-feather-phone-call icon-very-small margin-10px-right text-white"></i><?php echo e($contactInfo->phone ?? '+1
                            234 567 8910'); ?></div>



                        <div><i class="feather icon-feather-mail icon-very-small margin-10px-right text-white"></i><a
                                href="#"><?php echo e($contactInfo->email ?? 'info@yourdomain.com'); ?></a></div>
                    </div>
                    <!-- end footer column -->
                    <!-- start footer column -->
...
</html><?php /**PATH C:\xampp\htdocs\scindianew\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>