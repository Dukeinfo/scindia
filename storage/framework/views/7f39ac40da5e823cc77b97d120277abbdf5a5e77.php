            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Academics</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <img src="<?php echo e($thumb); ?>" alt="" class="border" width="100" height="70"></td>
                                            ...
                                            <td>                          
                                                <a href="<?php echo e(route('edit_sixth',['id' => $record->id])); ?>" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
...
<?php /**PATH C:\xampp\htdocs\laravel-livewire\resources\views/livewire/backend/home-content/sixth.blade.php ENDPATH**/ ?>