            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Class</h4>
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="" wire:model="classname" placeholder="classname">
...
unset($__errorArgs, $__bag); ?>
                               ...
                               <div>
                                <button type="submit" wire:loading.attr="disabled"  class="btn btn-primary w-md" wire:click="addClass">Submit</button>
                               
                            </div>
                            <div wire:loading wire:target="addClass">
                                ...
                                <table class="table table-bordered table-striped datatable">
                                    ...
                                    <tbody>
                                      <?php if(isset($records) && count($records)>0 ): ?>                      
                                        ...
                                        <tr>
                                            <td><?php echo e($record->classname ?? ''); ?></td>
                                         
                                            <td><?php echo e($record->sort_id ?? ''); ?></td>
                                            <td><span class="badge badge-soft-success"><?php echo e($record->status ?? ''); ?></span></td>
                                            <td>
                                                <a href="<?php echo e(url('/admin/edit/class')); ?>/<?php echo e($record->id); ?>" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
...
<?php /**PATH /home/sirsorg/public_html/resources/views/livewire/backend/master/view-class.blade.php ENDPATH**/ ?>