<div>
    <div class="modal fade <?php if($show === true): ?> show <?php endif; ?>"
         id="myExampleModal"
         style="display: <?php if($show === true): ?>
                 block
         <?php else: ?>
                 none
         <?php endif; ?>;"
    ...
    <div class="modal-backdrop fade show"
         ...
         <?php else: ?>
                 none
         <?php endif; ?>;"></div>
</div><?php /**PATH C:\xampp\htdocs\laravel-livewire\resources\views/livewire/modals/edit-resultx.blade.php ENDPATH**/ ?>