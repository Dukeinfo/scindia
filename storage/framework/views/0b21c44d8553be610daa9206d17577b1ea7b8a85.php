            ...
            <div class="row">
                ...
                <div class="col-md-e">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="" wire:model="title" placeholder="Title First">
...
unset($__errorArgs, $__bag); ?>
               ...
               <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="noticeBoardDate"  wire:model="noticeboarddate" placeholder="Date" onchange='Livewire.emit("selectDate", this.value)' autocomplete="off">

                                        <?php $__errorArgs = ['noticeboarddate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="error"><?php echo e($message); ?></span> <?php unset($message);
                                    ...
                                    <tbody>
                                      <?php if(isset($records) && count($records)>0 ): ?>                      
                                        ...
                                        <tr>
                                            ...
                                            <td>                               
                                                <a href="<?php echo e(route('edit_third',['id' => $record->id])); ?>" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
...
<?php /**PATH C:\xampp\htdocs\laravel-livewire\resources\views/livewire/backend/home-content/third.blade.php ENDPATH**/ ?>