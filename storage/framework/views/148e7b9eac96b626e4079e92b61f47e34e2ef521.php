...
} elseif ($_instance->childHasBeenRendered('OM0wcEa')) {
    $componentId = $_instance->getRenderedChildComponentId('OM0wcEa');
    $componentTag = $_instance->getRenderedChildComponentTagName('OM0wcEa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OM0wcEa');
} else {
    $response = \Livewire\Livewire::mount('modals.edit-resultx');
    $html = $response->html();
    $_instance->logRenderedChild('OM0wcEa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

    </body>
</html><?php /**PATH C:\xampp\htdocs\shiva-live\resources\views/layouts/backend.blade.php ENDPATH**/ ?>