...
<head>
    ...
    window.addEventListener('swal:confirm', event => { 
     ...
     <script>
      ...
      var picker7 = new Pikaday({ field: document.getElementById('noticeBoardDate') });
...
} elseif ($_instance->childHasBeenRendered('mEG5jeR')) {
    $componentId = $_instance->getRenderedChildComponentId('mEG5jeR');
    $componentTag = $_instance->getRenderedChildComponentTagName('mEG5jeR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mEG5jeR');
} else {
    $response = \Livewire\Livewire::mount('modals.edit-resultx');
    $html = $response->html();
    $_instance->logRenderedChild('mEG5jeR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

    </body>
</html><?php /**PATH C:\xampp\htdocs\laravel-livewire\resources\views/layouts/backend.blade.php ENDPATH**/ ?>