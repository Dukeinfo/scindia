...
<head>        
    ...
    <body>
                            ...
                            <div class="card-body pt-0"> 
                                    ...
                                    <div class="auth-logo-dark">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="<?php echo e(asset('admin_assets/images/logo.png')); ?>" alt="" class="" height="65">
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-2">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" :value="<?php echo e(old('email')); ?>" required autofocus class="form-control" id="Email" placeholder="Enter Email Address">
                                        </div>
                                        ...
                                        <div class="mt-4 text-center">
                                            <a href="<?php echo e(route('password.request')); ?>" class="text-muted"><i class="mdi mdi-lock me-1"></i> Forgot your password?</a>
                                        </div>
                                    </form>
                                </div>
        ...
        <!-- JAVASCRIPT -->
         <script src="<?php echo e(asset('public/admin_assets/libs')); ?>/jquery/jquery.min.js"></script>
        <script src="<?php echo e(asset('public/admin_assets/libs')); ?>/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script src="<?php echo e(asset('public/admin_assets/libs')); ?>/metismenu/metisMenu.min.js"></script>
        <script src="<?php echo e(asset('public/admin_assets/libs')); ?>/simplebar/simplebar.min.js"></script>
        <script src="<?php echo e(asset('public/admin_assets/libs')); ?>/node-waves/waves.min.js"></script>
        
        <!-- App js -->
        <script src="<?php echo e(asset('public/admin_assets/js')); ?>/app.js"></script>
    </body>
</html><?php /**PATH C:\xampp\htdocs\laravel-livewire\resources\views/auth/login.blade.php ENDPATH**/ ?>