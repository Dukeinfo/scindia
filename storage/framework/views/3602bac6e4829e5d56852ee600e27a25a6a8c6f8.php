...
} elseif ($_instance->childHasBeenRendered('7jn5aH1')) {
    $componentId = $_instance->getRenderedChildComponentId('7jn5aH1');
    $componentTag = $_instance->getRenderedChildComponentTagName('7jn5aH1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7jn5aH1');
} else {
    $response = \Livewire\Livewire::mount('modals.edit-resultx');
    $html = $response->html();
    $_instance->logRenderedChild('7jn5aH1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

    </body>
</html><?php /**PATH C:\xampp\htdocs\scindianew\resources\views/layouts/backend.blade.php ENDPATH**/ ?>