                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="" wire:model="name" placeholder="Section">
...
unset($__errorArgs, $__bag); ?>
                               ...
                               <div>
                                <button type="submit" wire:loading.attr="disabled"  class="btn btn-primary w-md" wire:click="addSection">Submit</button>
                                    ...
                                    <tbody>
                                      <?php if(isset($records) && count($records)>0 ): ?>                      
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(url('/admin/edit/section')); ?>/<?php echo e($record->id); ?>" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
...
<?php /**PATH /home/sirsorg/public_html/resources/views/livewire/backend/master/view-section.blade.php ENDPATH**/ ?>