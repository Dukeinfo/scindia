            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <img src="<?php echo e($thumb); ?>" alt="" class="border" width="100" height="70"></td>
                                            ...
                                            <td>                          
                                                <a href="<?php echo e(route('edit_seventh',['id' => $record->id])); ?>" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
...
<?php /**PATH C:\xampp\htdocs\laravel-livewire\resources\views/livewire/backend/home-content/seventh.blade.php ENDPATH**/ ?>