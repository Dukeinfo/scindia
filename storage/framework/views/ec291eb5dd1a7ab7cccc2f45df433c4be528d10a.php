            ...
            <div class="row">
                <div class="col-12 blog-content">
                    <ul
                        ...
                        <?php if(isset($contentFifth)): ?>
                                 <?php if(isset($contentFifth->image)): ?>
                                    <a href="<?php echo e($contentFifth->link ?? 'javascript:void()'); ?>"><img src="<?php echo e(getLifeatSKVImage($contentFifth->image ) ?? ''); ?>" alt=""></a> 
                                 <?php else: ?>
                   ...
                   <?php if(isset($contentFifth)): ?>
                       <a href="<?php echo e($contentFifth->link ?? 'javascript:void()'); ?>" class="blog-category alt-font"><?php echo e($contentFifth->title1 ?? "Boarding Life"); ?></a>
                   <?php else: ?> 
                   ...
                   <?php endif; ?> 
                     ...
                     <?php if(isset($contentFifth)): ?>
                     <a href="<?php echo e($contentFifth->link ?? 'javascript:void()'); ?>"
                                            class="alt-font text-white text-extra-large mb-0 d-block w-85 xl-w-100">
                                            </a>
                                            <?php echo e($contentFifth->title2 ?? "safe and Comfortable Home away from Home"); ?>
...
<!-- sixth (image,title,title2)-->
                        <li class="grid-item last-paragraph-no-margin wow animate__fadeIn">
                            <div class="blog-post">
                                <div class="blog-post-image bg-dark-slate-blue">
                        <?php if(isset($contentSixth)): ?>
                                 <?php if(isset($contentSixth->image)): ?>
                                     <img src="<?php echo e(getLifeatSKVImage($contentSixth->image ) ?? ''); ?>" alt="">
                                 <?php else: ?>
                        ...
                        <?php endif; ?> 
                                ...
                                <div
                                    ...
                                    <div class="mb-auto w-100">
                                  <?php if(isset($contentSixth)): ?>
                                         <a href="<?php echo e($contentSixth->link ?? 'javascript:void()'); ?>" class="blog-category alt-font"><?php echo e($contentSixth->title1 ?? "Academics"); ?></a>
                                  <?php else: ?>      
                                 ...
                                 <?php if(isset($contentSixth)): ?>
                                     <a href="<?php echo e($contentSixth->link ?? 'javascript:void()'); ?>"
                                            class="alt-font text-white text-extra-large mb-0 d-block w-85 xl-w-100"><?php echo e($contentSixth->title2 ?? "Education
                                            is the King"); ?></a>
                                 <?php else: ?>
                                        <a href="javascript:void()"
...
<!-- seventh (image,title,title2)-->
                        ...
                        <li class="grid-item last-paragraph-no-margin wow animate__fadeIn">
                            <div class="blog-post">
                                <div class="blog-post-image bg-dark-slate-blue">
                      <?php if(isset($contentSeventh)): ?>
                                 <?php if(isset($contentSeventh->image)): ?>
                                     <img src="<?php echo e(getLifeatSKVImage($contentSeventh->image ) ?? ''); ?>" alt="">
                                 <?php else: ?>
                        ...
                        <?php endif; ?> 
                                ...
                                <div
                                    ...
                                    <div class="mb-auto w-100">
                                       <?php if(isset($contentSeventh)): ?>
                                        <a href="<?php echo e($contentSeventh->link ?? 'javascript:void()'); ?>" class="blog-category alt-font"><?php echo e($contentSeventh->title1 ?? "Heritage"); ?></a>
                                       <?php else: ?>
                                    ...
                                    <div class="align-self-end w-100">
                                       ...
                                       <?php if(isset($contentSeventh)): ?>
                                         <a href="<?php echo e($contentSeventh->link ?? 'javascript:void()'); ?>"
                                            class="alt-font text-white text-extra-large mb-0 d-block w-85 xl-w-100"><?php echo e($contentSeventh->title2 ?? "Historical
                                            Foundation"); ?></a>
                                       <?php else: ?>  
                                        <a href="javascript:void()"
...
<!-- eight (image,title,title2)-->
                        <li class="grid-item grid-item-double wow animate__fadeIn last-paragraph-no-margin">
                            <div class="blog-post">
                                <div class="blog-post-image bg-dark-slate-blue">
                           <?php if(isset($contentEight)): ?>
                                 <?php if(isset($contentEight->image)): ?>
                                     <img src="<?php echo e(getLifeatSKVImage($contentEight->image ) ?? ''); ?>" alt="">
                                 <?php else: ?>
                        ...
                        <?php endif; ?>
                                ...
                                <div
                                    ...
                                    <div class="mb-auto w-100">
                                      <?php if(isset($contentEight)): ?>   
                                        <a href="<?php echo e($contentEight->link ?? 'javascript:void()'); ?>" class="blog-category alt-font"><?php echo e($contentEight->title1 ?? "Sports"); ?></a>
                                      <?php else: ?>
                                    ...
                                    <div class="align-self-end w-100">
                                      <?php if(isset($contentEight)): ?>    
                                        <a href="<?php echo e($contentEight->link ?? 'javascript:void()'); ?>"
                                            class="alt-font text-white text-extra-large mb-0 d-block w-85 xl-w-100"><?php echo e($contentEight->title2 ?? "World
...
<!-- nineth (image,title,title2)-->
                        <li class="grid-item last-paragraph-no-margin wow animate__fadeIn">
                            <div class="blog-post">
                                <div class="blog-post-image bg-dark-slate-blue">
                           <?php if(isset($contentNineth)): ?>
                                 <?php if(isset($contentNineth->image)): ?>
                                     <img src="<?php echo e(getLifeatSKVImage($contentNineth->image ) ?? ''); ?>" alt="">
                                 <?php else: ?>
                          ...
                          <?php endif; ?>
                                ...
                                <div
                                    ...
                                    <div class="mb-auto w-100">
                                       <?php if(isset($contentNineth)): ?>
                                        <a href="<?php echo e($contentNineth->link ?? 'javascript:void()'); ?>" class="blog-category alt-font"><?php echo e($contentNineth->title1 ?? "Infrastrucre"); ?></a>
                                       <?php else: ?> 
                                    ...
                                    <div class="align-self-end w-100">
                                       <?php if(isset($contentNineth)): ?>
                                         <a href="<?php echo e($contentNineth->link ?? 'javascript:void()'); ?>"
                                            class="alt-font text-white text-extra-large mb-0 d-block w-85 xl-w-100"><?php echo e($contentNineth->title2 ?? "State
...
<!-- tenth (image,title,title2)-->
                        <li class="grid-item last-paragraph-no-margin wow animate__fadeIn">
                            <div class="blog-post">
                                <div class="blog-post-image bg-dark-slate-blue">
                          <?php if(isset($contentTenth)): ?>
                                 <?php if(isset($contentTenth->image)): ?>
                                     <img src="<?php echo e(getLifeatSKVImage($contentTenth->image ) ?? ''); ?>" alt="">
                                 <?php else: ?>
                          ...
                          <?php endif; ?>
                                ...
                                <div
                                    ...
                                    <div class="mb-auto w-100">
                                    <?php if(isset($contentTenth)): ?>
                                        <a href="<?php echo e($contentTenth->link ?? 'javascript:void()'); ?>" class="blog-category alt-font"><?php echo e($contentTenth->title1 ?? "Leadership"); ?></a>
                                    <?php else: ?>    
                                    ...
                                    <div class="align-self-end w-100">
                                      <?php if(isset($contentTenth)): ?>
                                        <a href="<?php echo e($contentTenth->link ?? 'javascript:void()'); ?>"
                                            class="alt-font text-white text-extra-large mb-0 d-block w-85 xl-w-100"><?php echo e($contentTenth->title2 ?? "Expertise
                              ...
                              <div
                                    ...
                                    <div class="interactive-banners-box bg-extra-dark-gray">
                                        <div class="interactive-banners-box-image">
                                            <img src="<?php echo e(getfacility($facility->image ) ?? ''); ?>" alt="" />
                                        ...
                                        <div class="fancy-text-content padding-55px-lr md-padding-40px-lr">
                                            <span
                                                class="text-extra-small alt-font text-white text-uppercase padding-5px-tb padding-15px-lr bg-neon-orange margin-25px-bottom font-weight-500 d-inline-block"><?php echo e($facility->title); ?></span>
                                            <div
                                                class="alt-font font-weight-500 text-extra-large text-white margin-20px-bottom w-90">
                                                <?php echo e($facility->description); ?></div>
                                            <a href="<?php echo e($facility->link ?? 'javascript:void()'); ?>"
                 ...
                 <div class="swiper-slide text-center">
                                    <div
                                        ...
                                        <div class="feature-box-content">
                                            ...
                                            <span class="text-small"><?php echo e($testimonial->position ?? ""); ?></span>
                                        </div>
                                        <p class="margin-30px-top"><?php echo $testimonial->description ?? ''; ?></p>
                                    </div>
                                </div>
                   ...
                   <!-- show first new event -->
                    <div class="col-12 blog-post-content bg-white p-0 text-center">
                        <div class="blog-image">
                          <?php if(isset($newseventFirst)): ?> 
                             <a href="javascript:void()"><img
                                    src="<?php echo e(getboardmembers($newseventFirst->image ) ?? ''); ?>" alt="" /></a>
                          <?php else: ?>   
                            <a href="javascript:void()"><img
                        ...
                        <div class="blog-text d-inline-block w-100">
                            <div
                                ...
                                <div
                                    ...
                                    <?php if(isset($newseventFirst)): ?>
                                       <?php echo e(\Carbon\Carbon::parse($newseventFirst->dated)->isoFormat('MMM Do YYYY')); ?>
                                ...
                                <h6 class="alt-font font-weight-500"><a href="javascript:void()"
                                      ...
                                      <?php if(isset($newseventFirst)): ?>
                                        <?php echo e($newseventFirst->heading ?? 'Make business easy with
                        ...
                        <?php if(isset($newseventFirst)): ?>
                          <?php echo Str::limit($newseventFirst->description, 190) ?? ''; ?>
                       ...
                       <?php if(isset($newseventFirst)): ?>
                         ...
                         <a href="<?php echo e($newseventFirst->link ?? 'javascript:void()'); ?>"
...
?>                
                <div class="col-12 col-lg-4 blog-sidebar">
                    <ul class="blog-widget position-relative">
                        <!-- all events -->
                          <?php if(isset($newsevents) && count($newsevents) >0 ): ?>
                               <?php $__currentLoopData = $newsevents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newsevent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                  <li>
                            <div class="d-flex border-bottom border-color-extra-light-gray padding-30px-bottom">
                                <figure class="flex-shrink-0">
                                    <a href="javascript:void()"><img src="<?php echo e(getboardmembers($newsevent->image ) ?? ''); ?>"
                                            alt=""></a>
                                </figure>
                                <div class="media-body flex-grow-1">
                                    <a href="javascript:void()"
                                        class="text-extra-small alt-font d-block margin-5px-bottom"> <?php echo e(\Carbon\Carbon::parse($newsevent->dated)->isoFormat('MMM Do YYYY')); ?></a>
                                    <a href="javascript:void()"
                                        class="alt-font font-weight-500 text-extra-dark-gray margin-5px-bottom d-block line-height-22px text-neon-orange-hover"><?php echo e($newsevent->heading ?? ''); ?></a>
...
?>             
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <?php if(isset($clients) && count($clients) >0 ): ?>
                              ...
                              <div class="swiper-slide p-2">
                                <a href="<?php echo e($client->link ?? 'javascript:void()'); ?>" target="_blank">
                                    <img alt="" src="<?php echo e(getMembership($client->logo ) ?? ''); ?>" class="border">
                                </a>
                            </div>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php else: ?>
    ...
    </section><?php /**PATH C:\xampp\htdocs\scindianew\resources\views/livewire/frontend/home/homepage.blade.php ENDPATH**/ ?>