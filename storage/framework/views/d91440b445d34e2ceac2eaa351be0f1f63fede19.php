                    ...
                    <div class="col-12 blog-details-text last-paragraph-no-margin margin-6-rem-bottom">
                        <ul class="list-unstyled margin-2-rem-bottom">
                            <li class="d-inline-block align-middle margin-25px-right"><i class="feather icon-feather-calendar text-orange margin-10px-right"></i><a href="javascript:void()">
                             ...
                             <?php echo e(\Carbon\Carbon::parse($gallery->created_at)->isoFormat('MMMM Do YYYY')); ?>

                           
                           <!--  09 Septemper 2023 --></a></li>
                            <li class="d-inline-block align-middle margin-25px-right"><i class="feather icon-feather-folder text-orange margin-10px-right"></i><a href="javascript:void()"><?php echo e($category_name); ?></a></li>
                        </ul>
...
<?php if(isset($records) && count($records)>0 ): ?>                      
    <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        ...
        ?>
          ...
          <div class="swiper-slide"><img src="<?php echo e(getmultiple_images($image->image)); ?>" alt="" class="w-100">
          </div>
...
<?php /**PATH /home/sirsorg/public_html/resources/views/livewire/frontend/gallery-detail.blade.php ENDPATH**/ ?>