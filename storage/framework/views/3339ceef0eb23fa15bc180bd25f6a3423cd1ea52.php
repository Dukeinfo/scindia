...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Gallery Image (Max width:800 Max height:500 )</label>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped ">
                                    ...
                                    <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                        <tr>
                                            <td><?php echo e(getGalCategory($record->category_id) ?? ''); ?></td>
                                            <td> 
<?php                       
...
?>                                      
                                            ...
                                            <?php endif; ?></td>
                                            <td>
                                                <a href="<?php echo e(url('/admin/edit/gallery')); ?>/<?php echo e($record->id); ?>" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
...
<?php /**PATH C:\xampp\htdocs\laravel-livewire\resources\views/livewire/backend/gallery/manage-gallery.blade.php ENDPATH**/ ?>