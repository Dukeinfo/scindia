            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Rotate Box Items</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?php echo e(url('admin/dashboard')); ?>">Dashboard</a></li>
                                <li class="breadcrumb-item">Portfolio</li>
                                <li class="breadcrumb-item active">Rotate Box Items</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-transparent border-bottom py-3">
                            <h4 class="card-title">Rotate Box Items</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                            	...
                            	<div class="col-md-e">
                                    <div class="mb-3">
                                        <label class="form-label">Image (width:700 height:800)</label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-transparent border-bottom py-3">
                            <h4 class="card-title">Manage Rotate Box Items</h4>
                                    ...
                                    <tbody>
                                      <?php if(isset($records) && count($records)>0 ): ?>                      
                                        ...
                                        <tr>
                                           ...
                                           <td><?php echo $record->description ?str_limit($record->description, $limit=100 ) : ''; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(route('edit_rotate_items',['id' => $record->id])); ?>" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
...
<?php /**PATH C:\xampp\htdocs\scindia\resources\views/livewire/backend/rotate-items/view-rotate-item.blade.php ENDPATH**/ ?>