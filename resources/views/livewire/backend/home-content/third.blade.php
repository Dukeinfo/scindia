            ...
            <div class="row">
               ...
               <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        @error('noticeboarddate') <span class="error">{{ $message }}</span> @enderror
                                    </div>
            </div>
                                    ...
                                    <tbody>
                                      @if(isset($records) && count($records)>0 )                      
                                        ...
                                        <tr>
                                            ...
                                            <td>                               
                                                <a href="{{route('edit_third',['id' => $record->id])}}" class="text-success me-2" title="Edit"><i class="fa fa-edit fa-fw"></i></a>
